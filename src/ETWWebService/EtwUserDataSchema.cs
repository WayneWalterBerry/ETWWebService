...
namespace ETWWebService
{
    ...
    public class EtwUserDataSchema
    {
        ...
        /// </summary>
        private readonly Dictionary<string, List<UserDataColumn>> _eventSchema;

        /// <summary>
        /// Initializes a new instance of the EtwUserDataSchema class.
        /// </summary>
        public EtwUserDataSchema(Guid providerGuid,
            Dictionary<string, List<UserDataColumn>> eventSchema)
        {
            ProviderGuid = providerGuid;
            _eventSchema = eventSchema ?? new Dictionary<string, List<UserDataColumn>>();
        }
        ...
        public bool TryGetEventColumns(string eventId, out List<UserDataColumn> columns)
        {
        ...
        /// <param name="columns">The column definitions for the event if found</param>
        /// <returns>True if the event ID exists in the schema, false otherwise</returns>
        public bool TryGetEventColumns(int eventId, out List<UserDataColumn> columns)
        {
        ...
        public List<UserDataColumn> GetEventColumns(string eventId)
        {
        ...
        /// <param name="eventId">The event ID to query</param>
        /// <returns>The column definitions for the event, or null if not found</returns>
        public List<UserDataColumn> GetEventColumns(int eventId)
        {
        ...
        public IEnumerable<KeyValuePair<string, List<UserDataColumn>>> EnumerateEvents()
        {
